...
※ ゲーム仕様の変更は、実装後に README を更新します。

---

## 補足

- 神忍 5 体: 天津甦 / 黄泉返 / 八百万 / 御柱茜 / 界裂
- 被り時コイン変換: N 10 / R 30 / SR 80 / SSR 200 / UR 500 / 神忍 1000
- 参考デザイン: `sample/simple_typing_game.html`（参照用。アプリ本体とは別）
