...
export const difficultyConfigs: Record<DifficultyId, DifficultyConfig> = {
  trainee: {
    ...
    fallSpeed: 0.75,
    fallSpeedPerStage: 0.09,
    spawnIntervalMs: 2200,
    minSpawnIntervalMs: 1300,
    maxActiveTargets: 2,
    minChars: 3,
    maxChars: 5,
    problemCategories: ['basic', 'food', 'nature'],
    missDamage: 8,
    killHeal: 3,
    scoreMultiplier: 1,
    comboMultiplier: 1,
  ...
  ninja: {
    ...
    minChars: 5,
    maxChars: 10,
    problemCategories: ['basic', 'food', 'nature', 'phrase'],
    missDamage: 10,
    killHeal: 2,
  ...
  master: {
    ...
    fallSpeed: 1.45,
    fallSpeedPerStage: 0.18,
    spawnIntervalMs: 1300,
    minSpawnIntervalMs: 700,
    maxActiveTargets: 4,
    minChars: 7,
    maxChars: 14,
    problemCategories: ['nature', 'it', 'phrase'],
    missDamage: 14,
    killHeal: 1,
