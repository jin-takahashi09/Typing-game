...
export function SettingsScreen({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-4 py-10">
      <section className="panel-glow w-full max-w-lg rounded-[var(--radius-xl)] bg-black/90 px-6 py-8 md:px-10">
        <h1 className="font-display mb-8 text-center text-3xl text-[var(--color-accent-yellow)]">
          設定
        </h1>
